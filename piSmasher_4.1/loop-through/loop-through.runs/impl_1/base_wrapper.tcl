...
set rc [catch {
  ...
  set_property ip_output_repo Z:/Projects/piSmasher/piSmasher-testing/piSmasher_4.1/loop-through/loop-through.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  set_property XPM_LIBRARIES {XPM_CDC XPM_FIFO XPM_MEMORY} [current_project]
  add_files -quiet Z:/Projects/piSmasher/piSmasher-testing/piSmasher_4.1/loop-through/loop-through.runs/synth_1/base_wrapper.dcp
