...
module base_v_tpg_0_0_tpgPatternHorizontal (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
assign tmp_fu_40_p0 = x;

assign tmp_fu_40_p2 = ((tmp_fu_40_p0 == 16'd0) ? 1'b1 : 1'b0);

assign tmp_s_fu_58_p2 = ((color == 8'd0) ? 1'b1 : 1'b0);

endmodule //base_v_tpg_0_0_tpgPatternHorizontal
