...
HD_PWD='Z:/Projects/piSmasher/piSmasher-testing/hdmi-dynamic/hdmi-dynamic.runs/base_clk_wiz_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log base_clk_wiz_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source base_clk_wiz_0_0.tcl
