...
proc create_hier_cell_hdmi { parentCell nameHier } {
  ...
  # Create instance: hdmi_bus_ila, and set properties
  set hdmi_bus_ila [ create_bd_cell -type ip -vlnv xilinx.com:ip:system_ila:1.1 hdmi_bus_ila ]
  set_property -dict [ list \
   CONFIG.C_BRAM_CNT {6} \
  ...
  connect_bd_intf_net -intf_net v_vid_in_axi4s_0_vtiming_out [get_bd_intf_pins v_vid_in_axi4s_0/vtiming_out] [get_bd_intf_pins vtc_gen/vtiming_in]
  ...
  # Create port connections
  connect_bd_net -net HDMI_RX_DATA_1 [get_bd_pins HDMI_RX_DATA] [get_bd_pins hdmi_bus_ila/probe0] [get_bd_pins v_vid_in_axi4s_0/vid_data]
  connect_bd_net -net HDMI_RX_DE_1 [get_bd_pins HDMI_RX_DE] [get_bd_pins hdmi_bus_ila/probe3] [get_bd_pins v_vid_in_axi4s_0/vid_active_video]
  connect_bd_net -net HDMI_RX_HS_1 [get_bd_pins HDMI_RX_HS] [get_bd_pins hdmi_bus_ila/probe1] [get_bd_pins v_vid_in_axi4s_0/vid_hsync]
  connect_bd_net -net HDMI_RX_PCLK_1 [get_bd_pins HDMI_RX_PCLK] [get_bd_pins HDMI_TX_PCLK] [get_bd_pins hdmi_bus_ila/clk] [get_bd_pins proc_sys_reset_rx_pclk/slowest_sync_clk] [get_bd_pins v_axi4s_vid_out_0/vid_io_out_clk] [get_bd_pins v_vid_in_axi4s_0/vid_io_in_clk] [get_bd_pins vtc_gen/clk]
  connect_bd_net -net HDMI_RX_VS_1 [get_bd_pins HDMI_RX_VS] [get_bd_pins hdmi_bus_ila/probe2] [get_bd_pins v_vid_in_axi4s_0/vid_vsync]
  ...
  connect_bd_net -net hdmi_tx_HDMI_TX_DATA [get_bd_pins HDMI_TX_DATA] [get_bd_pins hdmi_bus_ila/probe4] [get_bd_pins v_axi4s_vid_out_0/vid_data]
  connect_bd_net -net hdmi_tx_HDMI_TX_DE [get_bd_pins HDMI_TX_DE] [get_bd_pins hdmi_bus_ila/probe7] [get_bd_pins v_axi4s_vid_out_0/vid_active_video]
  connect_bd_net -net hdmi_tx_HDMI_TX_HS [get_bd_pins HDMI_TX_HS] [get_bd_pins hdmi_bus_ila/probe5] [get_bd_pins v_axi4s_vid_out_0/vid_hsync]
  connect_bd_net -net hdmi_tx_HDMI_TX_VS [get_bd_pins HDMI_TX_VS] [get_bd_pins hdmi_bus_ila/probe6] [get_bd_pins v_axi4s_vid_out_0/vid_vsync]
  connect_bd_net -net hdmi_tx_vtc_introut [get_bd_pins vtc_gen_introut] [get_bd_pins vtc_gen/irq]
  connect_bd_net -net proc_sys_reset_100MHz_peripheral_aresetn [get_bd_pins peripheral_aresetn] [get_bd_pins axi_vdma_0/axi_resetn] [get_bd_pins stream_ila/resetn] [get_bd_pins v_axi4s_vid_out_0/aresetn] [get_bd_pins v_tpg_0/ap_rst_n] [get_bd_pins v_vid_in_axi4s_0/aresetn] [get_bd_pins vtc_gen/s_axi_aresetn]
  connect_bd_net -net proc_sys_reset_rx_pclk_peripheral_aresetn [get_bd_pins proc_sys_reset_rx_pclk/peripheral_aresetn] [get_bd_pins vtc_gen/resetn]
  ...
  connect_bd_net -net slowest_sync_clk_1 [get_bd_pins aclk] [get_bd_pins axi_vdma_0/m_axi_mm2s_aclk] [get_bd_pins axi_vdma_0/m_axi_s2mm_aclk] [get_bd_pins axi_vdma_0/m_axis_mm2s_aclk] [get_bd_pins axi_vdma_0/s_axi_lite_aclk] [get_bd_pins axi_vdma_0/s_axis_s2mm_aclk] [get_bd_pins stream_ila/clk] [get_bd_pins v_axi4s_vid_out_0/aclk] [get_bd_pins v_tpg_0/ap_clk] [get_bd_pins v_vid_in_axi4s_0/aclk] [get_bd_pins vtc_gen/s_axi_aclk]
  connect_bd_net -net v_axi4s_vid_out_0_vtg_ce [get_bd_pins v_axi4s_vid_out_0/vtg_ce] [get_bd_pins vtc_gen/gen_clken]
  connect_bd_net -net vcc_dout [get_bd_pins v_axi4s_vid_out_0/aclken] [get_bd_pins v_axi4s_vid_out_0/vid_io_out_ce] [get_bd_pins v_vid_in_axi4s_0/aclken] [get_bd_pins v_vid_in_axi4s_0/axis_enable] [get_bd_pins v_vid_in_axi4s_0/vid_io_in_ce] [get_bd_pins vcc/dout] [get_bd_pins vtc_gen/clken]
...
proc create_hier_cell_audio { parentCell nameHier } {
  ...
  set_property -dict [ list \
   CONFIG.CLKOUT1_JITTER {329.708} \
   CONFIG.CLKOUT1_PHASE_ERROR {267.741} \
   CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {12} \
   CONFIG.MMCM_CLKFBOUT_MULT_F {45.250} \
   CONFIG.MMCM_CLKOUT0_DIVIDE_F {82.875} \
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net proc_sys_reset_100MHz_peripheral_aresetn [get_bd_pins audio/resetn] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/M01_ARESETN] [get_bd_pins axi_interconnect_0/M02_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins hdmi/peripheral_aresetn] [get_bd_pins proc_sys_reset_150MHz/peripheral_aresetn] [get_bd_pins smartconnect_0/aresetn]
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins audio/clk_in1] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/M02_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins hdmi/aclk] [get_bd_pins proc_sys_reset_150MHz/slowest_sync_clk] [get_bd_pins processing_system7_0/FCLK_CLK2] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins smartconnect_0/aclk]
