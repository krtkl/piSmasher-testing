...
HD_PWD='Z:/Projects/piSmasher/piSmasher-testing/hdmi-1080p/hdmi-1080p.runs/base_system_ila_0_3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log base_system_ila_0_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source base_system_ila_0_3.tcl
