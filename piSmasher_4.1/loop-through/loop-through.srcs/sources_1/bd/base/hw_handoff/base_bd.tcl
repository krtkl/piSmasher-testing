...
proc create_hier_cell_hdmi { parentCell nameHier } {
  ...
  connect_bd_net -net proc_sys_reset_100MHz_peripheral_aresetn [get_bd_pins peripheral_aresetn] [get_bd_pins stream_ila/resetn] [get_bd_pins v_axi4s_vid_out_0/aresetn] [get_bd_pins v_tpg_0/ap_rst_n] [get_bd_pins v_vid_in_axi4s_0/aresetn] [get_bd_pins vtc_det/s_axi_aresetn] [get_bd_pins vtc_gen/s_axi_aresetn]
  ...
  connect_bd_net -net slowest_sync_clk_1 [get_bd_pins aclk] [get_bd_pins stream_ila/clk] [get_bd_pins v_axi4s_vid_out_0/aclk] [get_bd_pins v_tpg_0/ap_clk] [get_bd_pins v_vid_in_axi4s_0/aclk] [get_bd_pins vtc_det/s_axi_aclk] [get_bd_pins vtc_gen/s_axi_aclk]
