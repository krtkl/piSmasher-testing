...
set rc [catch {
  ...
  set_param board.repoPaths Z:/Software/snickerdoodle-board-files/
  ...
  add_files -quiet Z:/Projects/piSmasher/piSmasher-testing/piSmasher_4.1/hdmi-pass-through/hdmi-pass-through.runs/synth_1/base_wrapper.dcp
  ...
  set_param project.isImplRun true
  link_design -top base_wrapper -part xc7z020clg400-3
  set_param project.isImplRun false
