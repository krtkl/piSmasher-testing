...
HD_PWD='Z:/Projects/piSmasher/piSmasher-testing/hdmi-dynamic/hdmi-dynamic.runs/base_v_vid_in_axi4s_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log base_v_vid_in_axi4s_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source base_v_vid_in_axi4s_0_0.tcl
