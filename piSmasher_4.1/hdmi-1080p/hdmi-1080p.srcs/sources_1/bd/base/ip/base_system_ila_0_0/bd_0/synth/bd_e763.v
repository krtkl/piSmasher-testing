...
module bd_e763
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 SLOT_1_AXIS TDATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME SLOT_1_AXIS, CLK_DOMAIN base_processing_system7_0_0_FCLK_CLK3, FREQ_HZ 1.99998e+08, HAS_TKEEP 1, HAS_TLAST 1, HAS_TREADY 1, HAS_TSTRB 1, LAYERED_METADATA undef, PHASE 0.000, TDATA_NUM_BYTES 3, TDEST_WIDTH 1, TID_WIDTH 1, TUSER_WIDTH 1" *) input [23:0]SLOT_1_AXIS_tdata;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK, ASSOCIATED_BUSIF SLOT_0_AXIS:SLOT_1_AXIS, ASSOCIATED_RESET resetn, CLK_DOMAIN base_processing_system7_0_0_FCLK_CLK3, FREQ_HZ 1.99998e+08, PHASE 0.000" *) input clk;
  ...
  assign Conn1_TSTRB = SLOT_1_AXIS_tstrb[2:0];
  ...
  bd_e763_ila_lib_0 ila_lib
       (.clk(clk_1),
        ...
        .probe6(net_slot_1_axis_tdest),
        .probe7(net_slot_1_axis_tid),
        .probe8(net_slot_1_axis_tkeep),
        .probe9(net_slot_1_axis_tstrb));
endmodule
