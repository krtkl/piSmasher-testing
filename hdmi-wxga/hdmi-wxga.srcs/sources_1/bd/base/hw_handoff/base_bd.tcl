...
proc create_hier_cell_hdmi_audio { parentCell nameHier } {
  ...
  connect_bd_net -net HDMI_RX_LRCLK_1 [get_bd_pins HDMI_RX_LRCLK] [get_bd_pins HDMI_TX_SCLK]
  connect_bd_net -net HDMI_RX_SCLK_1 [get_bd_pins HDMI_RX_SCLK] [get_bd_pins HDMI_TX_LRCLK]
...
proc create_hier_cell_hdmi { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.CLKOUT1_JITTER {332.702} \
   CONFIG.CLKOUT1_PHASE_ERROR {383.128} \
   CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {85.5} \
   ...
   CONFIG.MMCM_CLKFBOUT_MULT_F {49.375} \
  ...
  set_property -dict [ list \
   ...
   CONFIG.GEN_F0_VBLANK_HSTART {1366} \
   CONFIG.GEN_F0_VFRAME_SIZE {798} \
   CONFIG.GEN_F0_VSYNC_HEND {1436} \
   CONFIG.GEN_F0_VSYNC_HSTART {1436} \
   CONFIG.GEN_F0_VSYNC_VEND {773} \
   ...
   CONFIG.GEN_HACTIVE_SIZE {1366} \
   CONFIG.GEN_HFRAME_SIZE {1792} \
   CONFIG.GEN_HSYNC_END {1579} \
   CONFIG.GEN_HSYNC_START {1436} \
   CONFIG.GEN_VACTIVE_SIZE {768} \
   CONFIG.HAS_AXI4_LITE {true} \
   CONFIG.HAS_INTC_IF {false} \
   CONFIG.VIDEO_MODE {Custom} \
  ...
  connect_bd_net -net HDMI_RX_PCLK_1 [get_bd_pins HDMI_RX_PCLK] [get_bd_pins hdmi_rx_ila/clk] [get_bd_pins proc_sys_reset_rx_pclk/slowest_sync_clk] [get_bd_pins v_vid_in_axi4s_0/vid_io_in_clk] [get_bd_pins vtc_det/clk]
  ...
  connect_bd_net -net ext_reset_in_1 [get_bd_pins ext_reset_in] [get_bd_pins clk_wiz_0/resetn] [get_bd_pins proc_sys_reset_rx_pclk/ext_reset_in] [get_bd_pins proc_sys_reset_tx_pclk/ext_reset_in]
  ...
  connect_bd_net -net hdmi_tx_HDMI_TX_PCLK [get_bd_pins HDMI_TX_PCLK] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins hdmi_tx_ila/clk] [get_bd_pins proc_sys_reset_tx_pclk/slowest_sync_clk] [get_bd_pins v_axi4s_vid_out_0/vid_io_out_clk] [get_bd_pins vtc_gen/clk]
  ...
  connect_bd_net -net proc_sys_reset_rx_pclk_peripheral_aresetn [get_bd_pins proc_sys_reset_rx_pclk/peripheral_aresetn] [get_bd_pins vtc_det/resetn]
  connect_bd_net -net proc_sys_reset_rx_pclk_peripheral_reset [get_bd_pins proc_sys_reset_rx_pclk/peripheral_reset] [get_bd_pins v_vid_in_axi4s_0/vid_io_in_reset]
  connect_bd_net -net proc_sys_reset_tx_pclk_peripheral_aresetn [get_bd_pins proc_sys_reset_tx_pclk/peripheral_aresetn] [get_bd_pins vtc_gen/resetn]
  connect_bd_net -net proc_sys_reset_tx_pclk_peripheral_reset [get_bd_pins proc_sys_reset_tx_pclk/peripheral_reset] [get_bd_pins v_axi4s_vid_out_0/vid_io_out_reset]
  connect_bd_net -net slowest_sync_clk_1 [get_bd_pins aclk] [get_bd_pins axi_vdma_0/m_axi_mm2s_aclk] [get_bd_pins axi_vdma_0/m_axi_s2mm_aclk] [get_bd_pins axi_vdma_0/m_axis_mm2s_aclk] [get_bd_pins axi_vdma_0/s_axi_lite_aclk] [get_bd_pins axi_vdma_0/s_axis_s2mm_aclk] [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins stream_ila/clk] [get_bd_pins v_axi4s_vid_out_0/aclk] [get_bd_pins v_tpg_0/ap_clk] [get_bd_pins v_vid_in_axi4s_0/aclk] [get_bd_pins vtc_det/s_axi_aclk] [get_bd_pins vtc_gen/s_axi_aclk]
...
proc create_hier_cell_ethernet { parentCell nameHier } {
  ...
  connect_bd_net -net gmii_clk_0_1 [get_bd_pins gmii_clk_0] [get_bd_pins gmii_to_rgmii_0/gmii_clk]
...
proc create_hier_cell_audio { parentCell nameHier } {
  ...
  # Create pins
  create_bd_pin -dir I -type clk AC_BCLK
  create_bd_pin -dir O AC_DIN
  create_bd_pin -dir I -from 0 -to 0 AC_DOUT
  create_bd_pin -dir O -type clk AC_MCLK
  create_bd_pin -dir I -from 0 -to 0 AC_WCLK
  ...
  set clk_wiz_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:clk_wiz:6.0 clk_wiz_0 ]
  set_property -dict [ list \
   CONFIG.CLKOUT1_JITTER {419.295} \
   CONFIG.CLKOUT1_PHASE_ERROR {386.562} \
   CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {12} \
   CONFIG.MMCM_CLKFBOUT_MULT_F {53.375} \
   CONFIG.MMCM_CLKOUT0_DIVIDE_F {74.125} \
   CONFIG.MMCM_DIVCLK_DIVIDE {6} \
   CONFIG.RESET_PORT {resetn} \
   CONFIG.RESET_TYPE {ACTIVE_LOW} \
 ] $clk_wiz_0
  ...
  connect_bd_net -net AC_DOUT_1 [get_bd_pins AC_DIN] [get_bd_pins AC_DOUT] [get_bd_pins system_ila_0/probe1]
  connect_bd_net -net AC_WCLK_1 [get_bd_pins AC_WCLK] [get_bd_pins system_ila_0/probe0]
  connect_bd_net -net clk_in1_1 [get_bd_pins clk_in1] [get_bd_pins clk_wiz_0/clk_in1]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins AC_MCLK] [get_bd_pins clk_wiz_0/clk_out1]
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net AC_DOUT_1 [get_bd_ports AC_DOUT] [get_bd_pins audio/AC_DOUT]
  connect_bd_net -net AC_WCLK_1 [get_bd_ports AC_WCLK] [get_bd_pins audio/AC_WCLK]
  connect_bd_net -net ARESETN_1 [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins proc_sys_reset_100MHz/interconnect_aresetn]
  ...
  connect_bd_net -net HDMI_RX_I2S_0_1 [get_bd_ports HDMI_RX_I2S] [get_bd_pins hdmi_audio/HDMI_RX_I2S]
  ...
  connect_bd_net -net proc_sys_reset_100MHz_peripheral_aresetn [get_bd_pins audio/resetn] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/M01_ARESETN] [get_bd_pins axi_interconnect_0/M02_ARESETN] [get_bd_pins axi_interconnect_0/M03_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins hdmi/peripheral_aresetn] [get_bd_pins proc_sys_reset_100MHz/peripheral_aresetn] [get_bd_pins smartconnect_0/aresetn]
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins audio/clk_in1] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/M02_ACLK] [get_bd_pins axi_interconnect_0/M03_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins hdmi/aclk] [get_bd_pins proc_sys_reset_100MHz/slowest_sync_clk] [get_bd_pins processing_system7_0/FCLK_CLK1] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins smartconnect_0/aclk]
  connect_bd_net -net processing_system7_0_FCLK_CLK3 [get_bd_pins ethernet/clkin] [get_bd_pins processing_system7_0/FCLK_CLK3]
  connect_bd_net -net processing_system7_0_FCLK_RESET1_N [get_bd_pins hdmi/ext_reset_in] [get_bd_pins proc_sys_reset_100MHz/ext_reset_in] [get_bd_pins processing_system7_0/FCLK_RESET1_N]
