...
HD_PWD='Z:/Projects/piSmasher/piSmasher-testing/hdmi-dynamic/hdmi-dynamic.runs/base_axi_vdma_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log base_axi_vdma_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source base_axi_vdma_0_0.tcl
