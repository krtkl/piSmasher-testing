...
HD_PWD='Z:/Projects/piSmasher/piSmasher_4.0_testing/piSmasher_4.0/piSmasher_4.0.runs/base_system_ila_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log base_system_ila_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source base_system_ila_0_2.tcl
