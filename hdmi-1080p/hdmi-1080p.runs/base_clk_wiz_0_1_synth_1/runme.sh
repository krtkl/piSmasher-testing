...
HD_PWD='Z:/Projects/piSmasher/piSmasher-testing/hdmi-1080p/hdmi-1080p.runs/base_clk_wiz_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log base_clk_wiz_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source base_clk_wiz_0_1.tcl
