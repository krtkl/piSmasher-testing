...
HD_PWD='Z:/Projects/piSmasher/piSmasher-testing/hdmi-dynamic/hdmi-dynamic.runs/base_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log base_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source base_auto_pc_0.tcl
