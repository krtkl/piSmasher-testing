...
HD_PWD='Z:/Projects/piSmasher/piSmasher_4.0_testing/piSmasher_4.0/piSmasher_4.0.runs/base_xlconcat_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log base_xlconcat_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source base_xlconcat_0_0.tcl
