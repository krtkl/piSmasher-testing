...
proc create_hier_cell_hdmi_tx { parentCell nameHier } {
  ...
  create_bd_pin -dir O -type clk HDMI_TX_PCLK
  ...
  # Create instance: proc_sys_reset_tx_pclk, and set properties
  set proc_sys_reset_tx_pclk [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 proc_sys_reset_tx_pclk ]
  ...
  connect_bd_net -net HDMI_TX_PCLK_1 [get_bd_pins HDMI_TX_PCLK] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins proc_sys_reset_tx_pclk/slowest_sync_clk] [get_bd_pins system_ila_0/clk] [get_bd_pins v_axi4s_vid_out_0/vid_io_out_clk] [get_bd_pins v_tc_0/clk]
  connect_bd_net -net aclk_1 [get_bd_pins aclk] [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins v_axi4s_vid_out_0/aclk]
  connect_bd_net -net aclken_1 [get_bd_pins aclken] [get_bd_pins v_axi4s_vid_out_0/aclken]
  connect_bd_net -net clk_wiz_0_locked [get_bd_pins clk_wiz_0/locked] [get_bd_pins proc_sys_reset_tx_pclk/dcm_locked]
  connect_bd_net -net clken_1 [get_bd_pins clken] [get_bd_pins v_tc_0/clken]
  connect_bd_net -net ext_reset_in_1 [get_bd_pins ext_reset_in] [get_bd_pins clk_wiz_0/resetn] [get_bd_pins proc_sys_reset_tx_pclk/ext_reset_in]
  connect_bd_net -net peripheral_aresetn_1 [get_bd_pins peripheral_aresetn] [get_bd_pins v_axi4s_vid_out_0/aresetn]
  connect_bd_net -net proc_sys_reset_tx_pclk_peripheral_aresetn [get_bd_pins proc_sys_reset_tx_pclk/peripheral_aresetn] [get_bd_pins v_tc_0/resetn]
  connect_bd_net -net v_axi4s_vid_out_0_vid_active_video [get_bd_pins HDMI_TX_DE] [get_bd_pins system_ila_0/probe3] [get_bd_pins v_axi4s_vid_out_0/vid_active_video]
  connect_bd_net -net v_axi4s_vid_out_0_vid_data [get_bd_pins HDMI_TX_DATA] [get_bd_pins system_ila_0/probe0] [get_bd_pins v_axi4s_vid_out_0/vid_data]
  connect_bd_net -net v_axi4s_vid_out_0_vid_hsync [get_bd_pins HDMI_TX_HS] [get_bd_pins system_ila_0/probe1] [get_bd_pins v_axi4s_vid_out_0/vid_hsync]
  connect_bd_net -net v_axi4s_vid_out_0_vid_vsync [get_bd_pins HDMI_TX_VS] [get_bd_pins system_ila_0/probe2] [get_bd_pins v_axi4s_vid_out_0/vid_vsync]
  connect_bd_net -net v_axi4s_vid_out_0_vtg_ce [get_bd_pins v_axi4s_vid_out_0/vtg_ce] [get_bd_pins v_tc_0/gen_clken]
  connect_bd_net -net vid_io_out_ce_1 [get_bd_pins vid_io_out_ce] [get_bd_pins v_axi4s_vid_out_0/vid_io_out_ce]
...
proc create_hier_cell_hdmi_rx { parentCell nameHier } {
  ...
  create_bd_pin -dir I -type rst ext_reset_in
  create_bd_pin -dir I -type rst peripheral_aresetn
  create_bd_pin -dir I -type ce vid_io_in_ce
  ...
  # Create port connections
  connect_bd_net -net HDMI_RX_DATA_1 [get_bd_pins HDMI_RX_DATA] [get_bd_pins system_ila_0/probe0] [get_bd_pins v_vid_in_axi4s_0/vid_data]
  connect_bd_net -net HDMI_RX_DE_1 [get_bd_pins HDMI_RX_DE] [get_bd_pins system_ila_0/probe3] [get_bd_pins v_vid_in_axi4s_0/vid_active_video]
  connect_bd_net -net HDMI_RX_HS_1 [get_bd_pins HDMI_RX_HS] [get_bd_pins system_ila_0/probe1] [get_bd_pins v_vid_in_axi4s_0/vid_hsync]
  connect_bd_net -net HDMI_RX_PCLK_1 [get_bd_pins HDMI_RX_PCLK] [get_bd_pins proc_sys_reset_rx_pclk/slowest_sync_clk] [get_bd_pins system_ila_0/clk] [get_bd_pins v_vid_in_axi4s_0/vid_io_in_clk]
  connect_bd_net -net HDMI_RX_VS_1 [get_bd_pins HDMI_RX_VS] [get_bd_pins system_ila_0/probe2] [get_bd_pins v_vid_in_axi4s_0/vid_vsync]
  connect_bd_net -net aclk_1 [get_bd_pins aclk] [get_bd_pins v_vid_in_axi4s_0/aclk]
  connect_bd_net -net aclken_1 [get_bd_pins aclken] [get_bd_pins v_vid_in_axi4s_0/aclken]
  connect_bd_net -net axis_enable_1 [get_bd_pins axis_enable] [get_bd_pins v_vid_in_axi4s_0/axis_enable]
  connect_bd_net -net ext_reset_in_1 [get_bd_pins ext_reset_in] [get_bd_pins proc_sys_reset_rx_pclk/ext_reset_in]
  connect_bd_net -net peripheral_aresetn_1 [get_bd_pins peripheral_aresetn] [get_bd_pins v_vid_in_axi4s_0/aresetn]
  connect_bd_net -net vid_io_in_ce_1 [get_bd_pins vid_io_in_ce] [get_bd_pins v_vid_in_axi4s_0/vid_io_in_ce]
...
# Hierarchical cell: capture_generate
proc create_hier_cell_capture_generate { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_msg_id "BD_TCL-102" "ERROR" "create_hier_cell_capture_generate() - Empty argument(s)!"}
     return
  }
  ...
  create_bd_pin -dir O -type intr tpg_introut
  ...
  connect_bd_intf_net -intf_net Conn3 [get_bd_intf_pins M_AXI_S2MM] [get_bd_intf_pins axi_vdma_0/M_AXI_S2MM]
  connect_bd_intf_net -intf_net Conn5 [get_bd_intf_pins S_AXIS_S2MM] [get_bd_intf_pins axi_vdma_0/S_AXIS_S2MM]
  connect_bd_intf_net -intf_net [get_bd_intf_nets Conn5] [get_bd_intf_pins S_AXIS_S2MM] [get_bd_intf_pins system_ila_0/SLOT_0_AXIS]
  connect_bd_intf_net -intf_net Conn9 [get_bd_intf_pins S_AXI_CTRL_TPG] [get_bd_intf_pins v_tpg_0/s_axi_CTRL]
  connect_bd_intf_net -intf_net Conn10 [get_bd_intf_pins m_axis_video] [get_bd_intf_pins v_tpg_0/m_axis_video]
  connect_bd_intf_net -intf_net [get_bd_intf_nets Conn10] [get_bd_intf_pins m_axis_video] [get_bd_intf_pins system_ila_0/SLOT_2_AXIS]
  ...
  # Create port connections
  connect_bd_net -net aclk_1 [get_bd_pins aclk] [get_bd_pins axi_vdma_0/m_axi_mm2s_aclk] [get_bd_pins axi_vdma_0/m_axi_s2mm_aclk] [get_bd_pins axi_vdma_0/m_axis_mm2s_aclk] [get_bd_pins axi_vdma_0/s_axi_lite_aclk] [get_bd_pins axi_vdma_0/s_axis_s2mm_aclk] [get_bd_pins system_ila_0/clk] [get_bd_pins v_tpg_0/ap_clk]
  ...
  connect_bd_net -net peripheral_aresetn_1 [get_bd_pins peripheral_aresetn] [get_bd_pins axi_vdma_0/axi_resetn] [get_bd_pins system_ila_0/resetn] [get_bd_pins v_tpg_0/ap_rst_n]
  connect_bd_net -net v_tpg_0_interrupt [get_bd_pins tpg_introut] [get_bd_pins v_tpg_0/interrupt]
...
proc create_hier_cell_hdmi { parentCell nameHier } {
  ...
  create_bd_pin -dir O HDMI_TX_DE
  create_bd_pin -dir O HDMI_TX_HS
  create_bd_pin -dir O HDMI_TX_PCLK
  create_bd_pin -dir O HDMI_TX_VS
  create_bd_pin -dir I -type clk aclk
  create_bd_pin -dir I -type rst ext_reset_in
  ...
  # Create instance: capture_generate
  create_hier_cell_capture_generate $hier_obj capture_generate

  # Create instance: hdmi_rx
  create_hier_cell_hdmi_rx $hier_obj hdmi_rx

  # Create instance: hdmi_tx
  create_hier_cell_hdmi_tx $hier_obj hdmi_tx
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net S_AXI_CTRL_TPG_1 [get_bd_intf_pins S_AXI_CTRL_TPG] [get_bd_intf_pins capture_generate/S_AXI_CTRL_TPG]
  connect_bd_intf_net -intf_net S_AXI_LITE_VDMA_1 [get_bd_intf_pins S_AXI_LITE_VDMA] [get_bd_intf_pins capture_generate/S_AXI_LITE_VDMA]
  connect_bd_intf_net -intf_net capture_generate_M_AXI_MM2S [get_bd_intf_pins M_AXI_MM2S] [get_bd_intf_pins capture_generate/M_AXI_MM2S]
  connect_bd_intf_net -intf_net capture_generate_M_AXI_S2MM [get_bd_intf_pins M_AXI_S2MM] [get_bd_intf_pins capture_generate/M_AXI_S2MM]
  connect_bd_intf_net -intf_net v_vid_in_axi4s_0_video_out [get_bd_intf_pins capture_generate/S_AXIS_S2MM] [get_bd_intf_pins hdmi_rx/video_out]
  connect_bd_intf_net -intf_net video_in_1 [get_bd_intf_pins capture_generate/m_axis_video] [get_bd_intf_pins hdmi_tx/video_in]

  # Create port connections
  connect_bd_net -net HDMI_RX_DATA_1 [get_bd_pins HDMI_RX_DATA] [get_bd_pins hdmi_rx/HDMI_RX_DATA]
  connect_bd_net -net HDMI_RX_DE_1 [get_bd_pins HDMI_RX_DE] [get_bd_pins hdmi_rx/HDMI_RX_DE]
  connect_bd_net -net HDMI_RX_HS_1 [get_bd_pins HDMI_RX_HS] [get_bd_pins hdmi_rx/HDMI_RX_HS]
  connect_bd_net -net HDMI_RX_PCLK_1 [get_bd_pins HDMI_RX_PCLK] [get_bd_pins hdmi_rx/HDMI_RX_PCLK]
  connect_bd_net -net HDMI_RX_VS_1 [get_bd_pins HDMI_RX_VS] [get_bd_pins hdmi_rx/HDMI_RX_VS]
  connect_bd_net -net capture_generate_mm2s_introut [get_bd_pins mm2s_introut] [get_bd_pins capture_generate/mm2s_introut]
  connect_bd_net -net capture_generate_s2mm_introut [get_bd_pins s2mm_introut] [get_bd_pins capture_generate/s2mm_introut]
  connect_bd_net -net capture_generate_tpg_introut [get_bd_pins tpg_introut] [get_bd_pins capture_generate/tpg_introut]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins HDMI_TX_PCLK] [get_bd_pins hdmi_tx/HDMI_TX_PCLK]
  connect_bd_net -net ext_reset_in_1 [get_bd_pins ext_reset_in] [get_bd_pins hdmi_rx/ext_reset_in] [get_bd_pins hdmi_tx/ext_reset_in] [get_bd_pins proc_sys_reset_100MHz/ext_reset_in]
  connect_bd_net -net hdmi_tx_HDMI_TX_DATA [get_bd_pins HDMI_TX_DATA] [get_bd_pins hdmi_tx/HDMI_TX_DATA]
  connect_bd_net -net hdmi_tx_HDMI_TX_DE [get_bd_pins HDMI_TX_DE] [get_bd_pins hdmi_tx/HDMI_TX_DE]
  connect_bd_net -net hdmi_tx_HDMI_TX_HS [get_bd_pins HDMI_TX_HS] [get_bd_pins hdmi_tx/HDMI_TX_HS]
  connect_bd_net -net hdmi_tx_HDMI_TX_VS [get_bd_pins HDMI_TX_VS] [get_bd_pins hdmi_tx/HDMI_TX_VS]
  connect_bd_net -net proc_sys_reset_100MHz_interconnect_aresetn [get_bd_pins interconnect_aresetn] [get_bd_pins proc_sys_reset_100MHz/interconnect_aresetn]
  connect_bd_net -net proc_sys_reset_100MHz_peripheral_aresetn [get_bd_pins peripheral_aresetn] [get_bd_pins capture_generate/peripheral_aresetn] [get_bd_pins hdmi_rx/peripheral_aresetn] [get_bd_pins hdmi_tx/peripheral_aresetn] [get_bd_pins proc_sys_reset_100MHz/peripheral_aresetn]
  connect_bd_net -net slowest_sync_clk_1 [get_bd_pins aclk] [get_bd_pins capture_generate/aclk] [get_bd_pins hdmi_rx/aclk] [get_bd_pins hdmi_tx/aclk] [get_bd_pins proc_sys_reset_100MHz/slowest_sync_clk] [get_bd_pins vio_0/clk]
  connect_bd_net -net vio_0_probe_out0 [get_bd_pins hdmi_rx/vid_io_in_ce] [get_bd_pins vio_0/probe_out0]
  connect_bd_net -net vio_0_probe_out1 [get_bd_pins hdmi_rx/vid_io_in_reset] [get_bd_pins vio_0/probe_out1]
  connect_bd_net -net vio_0_probe_out2 [get_bd_pins hdmi_rx/aclken] [get_bd_pins vio_0/probe_out2]
  connect_bd_net -net vio_0_probe_out3 [get_bd_pins hdmi_rx/axis_enable] [get_bd_pins vio_0/probe_out3]
  connect_bd_net -net vio_0_probe_out4 [get_bd_pins hdmi_tx/aclken] [get_bd_pins vio_0/probe_out4]
  connect_bd_net -net vio_0_probe_out5 [get_bd_pins hdmi_tx/vid_io_out_ce] [get_bd_pins vio_0/probe_out5]
  connect_bd_net -net vio_0_probe_out6 [get_bd_pins hdmi_tx/vid_io_out_reset] [get_bd_pins vio_0/probe_out6]
  connect_bd_net -net vio_0_probe_out7 [get_bd_pins hdmi_tx/clken] [get_bd_pins vio_0/probe_out7]
...
proc create_hier_cell_ethernet { parentCell nameHier } {
  ...
  create_bd_pin -dir I -type clk gmii_clk_1
  ...
  # Create port connections
  connect_bd_net -net ETH0_CLK125_1 [get_bd_pins gmii_clk_0] [get_bd_pins gmii_to_rgmii_0/gmii_clk]
  connect_bd_net -net ETH1_CLK125_1 [get_bd_pins gmii_clk_1] [get_bd_pins gmii_to_rgmii_1/gmii_clk]
  connect_bd_net -net clkin_1 [get_bd_pins clkin] [get_bd_pins gmii_to_rgmii_0/clkin] [get_bd_pins gmii_to_rgmii_1/clkin] [get_bd_pins proc_sys_reset_200MHz/slowest_sync_clk]
...
proc create_root_design { parentCell } {
  ...
  set AC_WCLK [ create_bd_port -dir O AC_WCLK ]
  ...
  # Create port connections
  connect_bd_net -net AC_DIN_1 [get_bd_ports AC_DIN] [get_bd_ports AC_DOUT]
  connect_bd_net -net ARESETN_1 [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins hdmi/interconnect_aresetn]
  connect_bd_net -net ETH0_CLK125_1 [get_bd_ports ETH0_CLK125] [get_bd_pins ethernet/gmii_clk_0]
  connect_bd_net -net ETH1_CLK125_1 [get_bd_ports ETH1_CLK125] [get_bd_pins ethernet/gmii_clk_1]
  ...
  connect_bd_net -net HDMI_RX_LRCLK_1 [get_bd_ports AC_WCLK] [get_bd_ports HDMI_RX_LRCLK] [get_bd_ports HDMI_TX_LRCLK]
  connect_bd_net -net HDMI_RX_PCLK_1 [get_bd_ports HDMI_RX_PCLK] [get_bd_pins hdmi/HDMI_RX_PCLK]
  connect_bd_net -net HDMI_RX_SCLK_1 [get_bd_ports AC_BCLK] [get_bd_ports AC_MCLK] [get_bd_ports HDMI_RX_SCLK] [get_bd_ports HDMI_TX_SCLK]
  connect_bd_net -net HDMI_RX_VS_1 [get_bd_ports HDMI_RX_VS] [get_bd_pins hdmi/HDMI_RX_VS]
  connect_bd_net -net S00_ARESETN_1 [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/M01_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins hdmi/peripheral_aresetn] [get_bd_pins smartconnect_0/aresetn]
  ...
  connect_bd_net -net hdmi_HDMI_TX_PCLK [get_bd_ports HDMI_TX_PCLK] [get_bd_pins hdmi/HDMI_TX_PCLK]
  connect_bd_net -net hdmi_HDMI_TX_VS [get_bd_ports HDMI_TX_VS] [get_bd_pins hdmi/HDMI_TX_VS]
  connect_bd_net -net hdmi_mm2s_introut [get_bd_pins hdmi/mm2s_introut] [get_bd_pins xlconcat_0/In2]
  connect_bd_net -net hdmi_s2mm_introut [get_bd_pins hdmi/s2mm_introut] [get_bd_pins xlconcat_0/In3]
  connect_bd_net -net hdmi_tpg_introut [get_bd_pins hdmi/tpg_introut] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins hdmi/aclk] [get_bd_pins processing_system7_0/FCLK_CLK1] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins smartconnect_0/aclk]
  connect_bd_net -net processing_system7_0_FCLK_CLK3 [get_bd_pins ethernet/clkin] [get_bd_pins processing_system7_0/FCLK_CLK3]
  connect_bd_net -net processing_system7_0_FCLK_RESET1_N [get_bd_pins hdmi/ext_reset_in] [get_bd_pins processing_system7_0/FCLK_RESET1_N]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43000000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs hdmi/capture_generate/axi_vdma_0/S_AXI_LITE/Reg] SEG_axi_vdma_0_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs hdmi/capture_generate/v_tpg_0/s_axi_CTRL/Reg] SEG_v_tpg_0_Reg
  create_bd_addr_seg -range 0x40000000 -offset 0x00000000 [get_bd_addr_spaces hdmi/capture_generate/axi_vdma_0/Data_MM2S] [get_bd_addr_segs processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] SEG_processing_system7_0_HP0_DDR_LOWOCM
  create_bd_addr_seg -range 0x40000000 -offset 0x00000000 [get_bd_addr_spaces hdmi/capture_generate/axi_vdma_0/Data_S2MM] [get_bd_addr_segs processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] SEG_processing_system7_0_HP0_DDR_LOWOCM

  # Exclude Address Segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43000000 [get_bd_addr_spaces hdmi/capture_generate/axi_vdma_0/Data_MM2S] [get_bd_addr_segs hdmi/capture_generate/axi_vdma_0/S_AXI_LITE/Reg] SEG_axi_vdma_0_Reg
  exclude_bd_addr_seg [get_bd_addr_segs hdmi/capture_generate/axi_vdma_0/Data_MM2S/SEG_axi_vdma_0_Reg]

  create_bd_addr_seg -range 0x00010000 -offset 0x43000000 [get_bd_addr_spaces hdmi/capture_generate/axi_vdma_0/Data_S2MM] [get_bd_addr_segs hdmi/capture_generate/axi_vdma_0/S_AXI_LITE/Reg] SEG_axi_vdma_0_Reg
  exclude_bd_addr_seg [get_bd_addr_segs hdmi/capture_generate/axi_vdma_0/Data_S2MM/SEG_axi_vdma_0_Reg]
