...
proc create_hier_cell_hdmi { parentCell nameHier } {
  ...
  # Create instance: hdmi_ila, and set properties
  set hdmi_ila [ create_bd_cell -type ip -vlnv xilinx.com:ip:system_ila:1.1 hdmi_ila ]
  ...
  connect_bd_intf_net -intf_net Conn1 [get_bd_intf_pins S_AXI_CTRL_TPG] [get_bd_intf_pins v_tpg_0/s_axi_CTRL]
  ...
  connect_bd_intf_net -intf_net v_vid_in_axi4s_0_video_out [get_bd_intf_pins v_tpg_0/s_axis_video] [get_bd_intf_pins v_vid_in_axi4s_0/video_out]
  connect_bd_intf_net -intf_net [get_bd_intf_nets v_vid_in_axi4s_0_video_out] [get_bd_intf_pins stream_ila/SLOT_0_AXIS] [get_bd_intf_pins v_tpg_0/s_axis_video]
  ...
  connect_bd_intf_net -intf_net [get_bd_intf_nets video_in_1] [get_bd_intf_pins stream_ila/SLOT_1_AXIS] [get_bd_intf_pins v_tpg_0/m_axis_video]

  # Create port connections
  connect_bd_net -net HDMI_RX_DATA_1 [get_bd_pins HDMI_RX_DATA] [get_bd_pins hdmi_ila/probe0] [get_bd_pins v_vid_in_axi4s_0/vid_data]
  connect_bd_net -net HDMI_RX_DE_1 [get_bd_pins HDMI_RX_DE] [get_bd_pins hdmi_ila/probe3] [get_bd_pins v_vid_in_axi4s_0/vid_active_video]
  connect_bd_net -net HDMI_RX_HS_1 [get_bd_pins HDMI_RX_HS] [get_bd_pins hdmi_ila/probe1] [get_bd_pins v_vid_in_axi4s_0/vid_hsync]
  connect_bd_net -net HDMI_RX_PCLK_1 [get_bd_pins HDMI_RX_PCLK] [get_bd_pins HDMI_TX_PCLK] [get_bd_pins hdmi_ila/clk] [get_bd_pins proc_sys_reset_rx_pclk/slowest_sync_clk] [get_bd_pins v_axi4s_vid_out_0/vid_io_out_clk] [get_bd_pins v_vid_in_axi4s_0/vid_io_in_clk] [get_bd_pins vtc_gen/clk]
  connect_bd_net -net HDMI_RX_VS_1 [get_bd_pins HDMI_RX_VS] [get_bd_pins hdmi_ila/probe2] [get_bd_pins v_vid_in_axi4s_0/vid_vsync]
  ...
  connect_bd_net -net hdmi_tx_HDMI_TX_DATA [get_bd_pins HDMI_TX_DATA] [get_bd_pins hdmi_ila/probe4] [get_bd_pins v_axi4s_vid_out_0/vid_data]
  connect_bd_net -net hdmi_tx_HDMI_TX_DE [get_bd_pins HDMI_TX_DE] [get_bd_pins hdmi_ila/probe7] [get_bd_pins v_axi4s_vid_out_0/vid_active_video]
  connect_bd_net -net hdmi_tx_HDMI_TX_HS [get_bd_pins HDMI_TX_HS] [get_bd_pins hdmi_ila/probe5] [get_bd_pins v_axi4s_vid_out_0/vid_hsync]
  connect_bd_net -net hdmi_tx_HDMI_TX_VS [get_bd_pins HDMI_TX_VS] [get_bd_pins hdmi_ila/probe6] [get_bd_pins v_axi4s_vid_out_0/vid_vsync]
  connect_bd_net -net proc_sys_reset_100MHz_peripheral_aresetn [get_bd_pins peripheral_aresetn] [get_bd_pins stream_ila/resetn] [get_bd_pins v_axi4s_vid_out_0/aresetn] [get_bd_pins v_tpg_0/ap_rst_n] [get_bd_pins v_vid_in_axi4s_0/aresetn]
  ...
  connect_bd_net -net slowest_sync_clk_1 [get_bd_pins aclk] [get_bd_pins stream_ila/clk] [get_bd_pins v_axi4s_vid_out_0/aclk] [get_bd_pins v_tpg_0/ap_clk] [get_bd_pins v_vid_in_axi4s_0/aclk]
  connect_bd_net -net v_axi4s_vid_out_0_vtg_ce [get_bd_pins v_axi4s_vid_out_0/vtg_ce] [get_bd_pins vtc_gen/gen_clken]
  connect_bd_net -net vcc_dout [get_bd_pins v_axi4s_vid_out_0/aclken] [get_bd_pins v_axi4s_vid_out_0/vid_io_out_ce] [get_bd_pins v_vid_in_axi4s_0/aclken] [get_bd_pins v_vid_in_axi4s_0/axis_enable] [get_bd_pins v_vid_in_axi4s_0/vid_io_in_ce] [get_bd_pins vcc/dout] [get_bd_pins vtc_gen/clken] [get_bd_pins vtc_gen/det_clken]
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.CLKOUT2_JITTER {185.733} \
   CONFIG.CLKOUT2_PHASE_ERROR {146.901} \
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net S_AXI_CTRL_TPG_1 [get_bd_intf_pins axi_interconnect_0/M00_AXI] [get_bd_intf_pins hdmi/S_AXI_CTRL_TPG]
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins audio/AC_MCLK_in] [get_bd_pins clk_wiz_0/clk_out1]
  ...
  connect_bd_net -net hdmi_HDMI_TX_PCLK_out [get_bd_ports HDMI_TX_PCLK] [get_bd_pins hdmi/HDMI_TX_PCLK]
  ...
  connect_bd_net -net proc_sys_reset_100MHz_peripheral_aresetn [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins hdmi/peripheral_aresetn] [get_bd_pins proc_sys_reset_150MHz/peripheral_aresetn]
  connect_bd_net -net processing_system7_0_FCLK_CLK3 [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins ethernet/clkin] [get_bd_pins hdmi/aclk] [get_bd_pins proc_sys_reset_150MHz/slowest_sync_clk] [get_bd_pins processing_system7_0/FCLK_CLK3] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK]
