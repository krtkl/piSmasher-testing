...
################################################################
# This is a generated script based on design: bd_27a2
#
...
proc create_root_design { parentCell } {
  ...
  set probe0 [ create_bd_port -dir I -from 23 -to 0 probe0 ]
  ...
  set probe4 [ create_bd_port -dir I -from 23 -to 0 probe4 ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.C_ILA_CLK_FREQ {148500000} \
