...
HD_PWD='Z:/Projects/piSmasher/piSmasher-testing/piSmasher_4.1/hdmi-pass-through/hdmi-pass-through.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log base_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source base_wrapper.tcl
