...
module base_v_tpg_0_0_MultiPixStream2AXIvi (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [0:0] exitcond4_reg_477;
reg    strmPix_V_val_1_V_blk_n;
reg    strmPix_V_val_2_V_blk_n;
reg    m_axis_video_TDATA_blk_n;
reg    ap_enable_reg_pp0_iter2;
reg   [0:0] exitcond4_reg_477_pp0_iter1_reg;
reg    ap_enable_reg_pp0_iter3;
reg   [0:0] exitcond4_reg_477_pp0_iter2_reg;
...
reg  signed [15:0] tmp_reg_453;
wire  signed [15:0] grp_reg_unsigned_short_s_fu_263_ap_return;
reg  signed [15:0] tmp_s_reg_458;
wire   [16:0] tmp_128_fu_278_p2;
reg   [16:0] tmp_128_reg_463;
wire   [0:0] exitcond3_fu_284_p2;
wire    ap_CS_fsm_state3;
reg    ap_block_state3;
wire  signed [15:0] i_1_fu_289_p2;
reg  signed [15:0] i_1_reg_472;
...
reg   [0:0] tmp_last_V_reg_486;
reg   [0:0] tmp_last_V_reg_486_pp0_iter1_reg;
reg   [7:0] tmp_val_0_V_reg_491;
reg   [7:0] tmp_val_1_V_reg_496;
reg   [7:0] tmp_val_2_V_reg_502;
wire   [23:0] p_Result_3_fu_327_p3;
wire   [23:0] p_Result_s_fu_335_p3;
wire   [23:0] p_Result_4_fu_343_p3;
...
wire   [23:0] ap_phi_reg_pp0_iter0_p_019_0_2_reg_221;
reg   [23:0] ap_phi_reg_pp0_iter1_p_019_0_2_reg_221;
reg   [23:0] ap_phi_reg_pp0_iter2_p_019_0_2_reg_221;
reg   [23:0] ap_phi_mux_p_019_0_2_0_1_phi_fu_235_p6;
wire   [23:0] p_Result_4_0_1_fu_375_p5;
wire   [23:0] ap_phi_reg_pp0_iter2_p_019_0_2_0_1_reg_232;
wire   [23:0] p_Result_3_0_1_fu_351_p5;
wire   [23:0] p_Result_0_1_fu_363_p5;
reg   [23:0] ap_phi_mux_tmp_data_V_phi_fu_247_p6;
wire   [23:0] p_Result_4_0_2_fu_411_p5;
wire   [23:0] ap_phi_reg_pp0_iter2_tmp_data_V_reg_243;
wire   [23:0] p_Result_3_0_2_fu_387_p5;
wire   [23:0] p_Result_0_2_fu_399_p5;
...
base_v_tpg_0_0_reg_unsigned_short_s grp_reg_unsigned_short_s_fu_257(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
base_v_tpg_0_0_reg_unsigned_short_s grp_reg_unsigned_short_s_fu_263(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b0 == ap_block_pp0_stage0_subdone) & (1'b1 == ap_condition_pp0_exit_iter0_state4) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            ap_enable_reg_pp0_iter0 <= 1'b0;
        end else if ((~((1'b0 == AXI_video_strm_V_data_V_1_ack_in) | (1'b0 == AXI_video_strm_V_dest_V_1_ack_in) | (1'b0 == AXI_video_strm_V_id_V_1_ack_in) | (1'b0 == AXI_video_strm_V_last_V_1_ack_in) | (1'b0 == AXI_video_strm_V_user_V_1_ack_in) | (1'b0 == AXI_video_strm_V_strb_V_1_ack_in) | (1'b0 == AXI_video_strm_V_keep_V_1_ack_in)) & (exitcond3_fu_284_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state3))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_650)) begin
        if (((exitcond4_reg_477 == 1'd0) & (colorFormat_read_read_fu_154_p2 == 8'd0))) begin
            ap_phi_reg_pp0_iter2_p_019_0_2_reg_221 <= p_Result_s_fu_335_p3;
        end else if (((exitcond4_reg_477 == 1'd0) & (colorFormat_read_read_fu_154_p2 == 8'd1))) begin
            ap_phi_reg_pp0_iter2_p_019_0_2_reg_221 <= p_Result_3_fu_327_p3;
        end else if ((1'b1 == ap_condition_612)) begin
            ap_phi_reg_pp0_iter2_p_019_0_2_reg_221 <= p_Result_4_fu_343_p3;
        end else if ((1'b1 == 1'b1)) begin
            ap_phi_reg_pp0_iter2_p_019_0_2_reg_221 <= ap_phi_reg_pp0_iter1_p_019_0_2_reg_221;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((~((1'b0 == AXI_video_strm_V_data_V_1_ack_in) | (1'b0 == AXI_video_strm_V_dest_V_1_ack_in) | (1'b0 == AXI_video_strm_V_id_V_1_ack_in) | (1'b0 == AXI_video_strm_V_last_V_1_ack_in) | (1'b0 == AXI_video_strm_V_user_V_1_ack_in) | (1'b0 == AXI_video_strm_V_strb_V_1_ack_in) | (1'b0 == AXI_video_strm_V_keep_V_1_ack_in)) & (exitcond3_fu_284_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state3))) begin
        j_reg_210 <= 16'd0;
    end else if (((exitcond4_fu_299_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        j_reg_210 <= j_1_fu_304_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((exitcond4_reg_477_pp0_iter1_reg == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter2 == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == AXI_video_strm_V_last_V_1_load_A)) begin
        AXI_video_strm_V_last_V_1_payload_A <= tmp_last_V_reg_486_pp0_iter1_reg;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == AXI_video_strm_V_last_V_1_load_B)) begin
        AXI_video_strm_V_last_V_1_payload_B <= tmp_last_V_reg_486_pp0_iter1_reg;
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ap_phi_reg_pp0_iter1_p_019_0_2_reg_221 <= ap_phi_reg_pp0_iter0_p_019_0_2_reg_221;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        exitcond4_reg_477 <= exitcond4_fu_299_p2;
        exitcond4_reg_477_pp0_iter1_reg <= exitcond4_reg_477;
        tmp_last_V_reg_486_pp0_iter1_reg <= tmp_last_V_reg_486;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        exitcond4_reg_477_pp0_iter2_reg <= exitcond4_reg_477_pp0_iter1_reg;
    end
end
...
always @ (posedge ap_clk) begin
    if ((~((1'b0 == AXI_video_strm_V_data_V_1_ack_in) | (1'b0 == AXI_video_strm_V_dest_V_1_ack_in) | (1'b0 == AXI_video_strm_V_id_V_1_ack_in) | (1'b0 == AXI_video_strm_V_last_V_1_ack_in) | (1'b0 == AXI_video_strm_V_user_V_1_ack_in) | (1'b0 == AXI_video_strm_V_strb_V_1_ack_in) | (1'b0 == AXI_video_strm_V_keep_V_1_ack_in)) & (1'b1 == ap_CS_fsm_state3))) begin
        i_1_reg_472 <= i_1_fu_289_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_state2_on_subcall_done) & (1'b1 == ap_CS_fsm_state2))) begin
        tmp_128_reg_463 <= tmp_128_fu_278_p2;
        tmp_reg_453 <= grp_reg_unsigned_short_s_fu_257_ap_return;
        tmp_s_reg_458 <= grp_reg_unsigned_short_s_fu_263_ap_return;
    end
end

always @ (posedge ap_clk) begin
    if (((exitcond4_fu_299_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        tmp_last_V_reg_486 <= tmp_last_V_fu_310_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((exitcond4_reg_477 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        tmp_val_0_V_reg_491 <= strmPix_V_val_0_V_dout;
        tmp_val_1_V_reg_496 <= strmPix_V_val_1_V_dout;
        tmp_val_2_V_reg_502 <= strmPix_V_val_2_V_dout;
    end
end
...
always @ (*) begin
    if ((exitcond4_fu_299_p2 == 1'd1)) begin
...
always @ (*) begin
    if ((1'b1 == ap_condition_475)) begin
        if ((colorFormat_read_read_fu_154_p2 == 8'd0)) begin
            ap_phi_mux_p_019_0_2_0_1_phi_fu_235_p6 = p_Result_0_1_fu_363_p5;
        end else if ((colorFormat_read_read_fu_154_p2 == 8'd1)) begin
            ap_phi_mux_p_019_0_2_0_1_phi_fu_235_p6 = p_Result_3_0_1_fu_351_p5;
        end else if ((~(colorFormat_read_read_fu_154_p2 == 8'd0) & ~(colorFormat_read_read_fu_154_p2 == 8'd1))) begin
            ap_phi_mux_p_019_0_2_0_1_phi_fu_235_p6 = p_Result_4_0_1_fu_375_p5;
        end else begin
            ap_phi_mux_p_019_0_2_0_1_phi_fu_235_p6 = ap_phi_reg_pp0_iter2_p_019_0_2_0_1_reg_232;
        end
    end else begin
        ap_phi_mux_p_019_0_2_0_1_phi_fu_235_p6 = ap_phi_reg_pp0_iter2_p_019_0_2_0_1_reg_232;
    end
...
always @ (*) begin
    if ((1'b1 == ap_condition_475)) begin
        if ((colorFormat_read_read_fu_154_p2 == 8'd0)) begin
            ap_phi_mux_tmp_data_V_phi_fu_247_p6 = p_Result_0_2_fu_399_p5;
        end else if ((colorFormat_read_read_fu_154_p2 == 8'd1)) begin
            ap_phi_mux_tmp_data_V_phi_fu_247_p6 = p_Result_3_0_2_fu_387_p5;
        end else if ((~(colorFormat_read_read_fu_154_p2 == 8'd0) & ~(colorFormat_read_read_fu_154_p2 == 8'd1))) begin
            ap_phi_mux_tmp_data_V_phi_fu_247_p6 = p_Result_4_0_2_fu_411_p5;
        end else begin
            ap_phi_mux_tmp_data_V_phi_fu_247_p6 = ap_phi_reg_pp0_iter2_tmp_data_V_reg_243;
        end
    end else begin
        ap_phi_mux_tmp_data_V_phi_fu_247_p6 = ap_phi_reg_pp0_iter2_tmp_data_V_reg_243;
    end
...
always @ (*) begin
    if ((((exitcond4_reg_477_pp0_iter2_reg == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter3 == 1'b1)) | ((exitcond4_reg_477_pp0_iter1_reg == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter2 == 1'b1)))) begin
...
always @ (*) begin
    if (((exitcond4_reg_477 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((exitcond4_reg_477 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if ((~((exitcond4_fu_299_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1)) & ~((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter2 == 1'b0) & (ap_enable_reg_pp0_iter3 == 1'b1)))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if ((((exitcond4_fu_299_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1)) | ((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter2 == 1'b0) & (ap_enable_reg_pp0_iter3 == 1'b1)))) begin
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((exitcond4_reg_477 == 1'd0) & (strmPix_V_val_0_V0_status == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((1'b1 == ap_block_state7_io) & (ap_enable_reg_pp0_iter3 == 1'b1)) | ((1'b1 == ap_block_state6_io) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((exitcond4_reg_477 == 1'd0) & (strmPix_V_val_0_V0_status == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((1'b1 == ap_block_state7_io) & (ap_enable_reg_pp0_iter3 == 1'b1)) | ((1'b1 == ap_block_state6_io) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((exitcond4_reg_477 == 1'd0) & (strmPix_V_val_0_V0_status == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end
...
always @ (*) begin
    ap_block_state5_pp0_stage0_iter1 = ((exitcond4_reg_477 == 1'd0) & (strmPix_V_val_0_V0_status == 1'b0));
end

always @ (*) begin
    ap_block_state6_io = ((exitcond4_reg_477_pp0_iter1_reg == 1'd0) & (1'b0 == AXI_video_strm_V_data_V_1_ack_in));
end

assign ap_block_state6_pp0_stage0_iter2 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state7_io = ((exitcond4_reg_477_pp0_iter2_reg == 1'd0) & (1'b0 == AXI_video_strm_V_data_V_1_ack_in));
end

assign ap_block_state7_pp0_stage0_iter3 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_condition_475 = ((exitcond4_reg_477_pp0_iter1_reg == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter2 == 1'b1));
end

always @ (*) begin
    ap_condition_612 = (~(colorFormat_read_read_fu_154_p2 == 8'd0) & ~(colorFormat_read_read_fu_154_p2 == 8'd1) & (exitcond4_reg_477 == 1'd0));
end
...
assign ap_phi_reg_pp0_iter0_p_019_0_2_reg_221 = 'bx;

assign ap_phi_reg_pp0_iter2_p_019_0_2_0_1_reg_232 = 'bx;

assign ap_phi_reg_pp0_iter2_tmp_data_V_reg_243 = 'bx;
...
assign exitcond3_fu_284_p2 = ((i_reg_199 == tmp_reg_453) ? 1'b1 : 1'b0);

assign exitcond4_fu_299_p2 = ((j_reg_210 == tmp_s_reg_458) ? 1'b1 : 1'b0);
...
assign p_Result_0_1_fu_363_p5 = {{ap_phi_reg_pp0_iter2_p_019_0_2_reg_221[23:16]}, {tmp_val_2_V_reg_502}, {ap_phi_reg_pp0_iter2_p_019_0_2_reg_221[7:0]}};

assign p_Result_0_2_fu_399_p5 = {{tmp_val_0_V_reg_491}, {ap_phi_mux_p_019_0_2_0_1_phi_fu_235_p6[15:0]}};

assign p_Result_3_0_1_fu_351_p5 = {{ap_phi_reg_pp0_iter2_p_019_0_2_reg_221[23:16]}, {tmp_val_1_V_reg_496}, {ap_phi_reg_pp0_iter2_p_019_0_2_reg_221[7:0]}};

assign p_Result_3_0_2_fu_387_p5 = {{tmp_val_2_V_reg_502}, {ap_phi_mux_p_019_0_2_0_1_phi_fu_235_p6[15:0]}};

assign p_Result_3_fu_327_p3 = {{16'd65535}, {strmPix_V_val_0_V_dout}};

assign p_Result_4_0_1_fu_375_p5 = {{ap_phi_reg_pp0_iter2_p_019_0_2_reg_221[23:16]}, {tmp_val_1_V_reg_496}, {ap_phi_reg_pp0_iter2_p_019_0_2_reg_221[7:0]}};

assign p_Result_4_0_2_fu_411_p5 = {{tmp_val_2_V_reg_502}, {ap_phi_mux_p_019_0_2_0_1_phi_fu_235_p6[15:0]}};

assign p_Result_4_fu_343_p3 = {{16'd65535}, {strmPix_V_val_0_V_dout}};

assign p_Result_s_fu_335_p3 = {{16'd65535}, {strmPix_V_val_1_V_dout}};
...
assign tmp_128_fu_278_p2 = ($signed(cols_cast_fu_274_p1) + $signed(17'd131071));

assign tmp_last_V_fu_310_p2 = ((j_cast_fu_295_p1 == tmp_128_reg_463) ? 1'b1 : 1'b0);

endmodule //base_v_tpg_0_0_MultiPixStream2AXIvi
