...
HD_PWD='Z:/Projects/piSmasher/piSmasher-testing/hdmi-dynamic/hdmi-dynamic.runs/base_proc_sys_reset_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log base_proc_sys_reset_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source base_proc_sys_reset_0_2.tcl
